...
public class SpeedControl : MonoBehaviour {
    ...
    void Start ()
    {
      ...
      LeftTurns = new KeyCombo[] {
        new KeyCombo("RightStickX", "RightStickY", new string[] {"up", "left", "down"}, TURN_INPUTS),
        new KeyCombo("RightStickX", "RightStickY", new string[] {"down", "right", "up"}, TURN_INPUTS)
      };

      RightTurns = new KeyCombo[] {
        new KeyCombo("RightStickX", "RightStickY", new string[] {"up", "right", "down"}, TURN_INPUTS),
        new KeyCombo("RightStickX", "RightStickY", new string[] {"down", "left", "up"}, TURN_INPUTS)
      };
